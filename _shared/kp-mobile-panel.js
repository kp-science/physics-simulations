...
(function(){
  ...
  var CFG = {}, BP = 900;
  var CSS = ''
  + '#kpMBar{position:fixed;left:0;right:0;bottom:0;z-index:960;display:none;background:rgba(8,13,24,.96);border-top:1px solid #1e3a5f;padding:6px 8px calc(7px + env(safe-area-inset-bottom));font-family:Sarabun,sans-serif;-webkit-backdrop-filter:blur(6px);backdrop-filter:blur(6px)}'
  ...
  + '#kpMBar .pk .go{flex-shrink:0;border:none;border-radius:8px;background:#f59e0b;color:#111;font:700 .8rem Sarabun,sans-serif;padding:8px 10px}'
  + '#kpMBar .tabs{display:flex;gap:6px}'
  + '#kpMBar .tabs button{flex:1;padding:10px 4px;border-radius:10px;border:1px solid #334155;background:#1a2235;color:#e2e8f0;font:700 .92rem Sarabun,sans-serif}'
  ...
  + '#kpSheet .sh{display:flex;align-items:center;gap:8px;padding:4px 10px 6px;border-bottom:1px solid #1e3a5f;font:700 .9rem Sarabun,sans-serif;color:#7dd3fc;touch-action:none}'
  ...
  + '#kpSheet .sh button{margin-top:8px;border:1px solid #334155;background:#1a2235;color:#e2e8f0;border-radius:8px;padding:6px 10px;font:700 .8rem Sarabun,sans-serif}'
