...
def check_file(filepath):
    ...
    is_sim = '/Virtual Physics Lab 01/' in filepath or '/Virtual Physics Lab 02/' in filepath or '/Virtual Physics Lab 03/' in filepath or '/Virtual Physics Lab 04/' in filepath or '/Virtual Physics Lab 05/' in filepath or '/Demo/' in filepath
    ...
    is_vlab = '/Virtual Physics Lab 01/' in filepath or '/Virtual Physics Lab 02/' in filepath or '/Virtual Physics Lab 03/' in filepath or '/Virtual Physics Lab 04/' in filepath or '/Virtual Physics Lab 05/' in filepath
