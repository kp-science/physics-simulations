...
SERIES_PAGES={
 ...
 'vpl06':{'file':'virtual-physics-lab-06.html','icon':'🔋','badge':'VIRTUAL PHYSICS LAB 06 · ไฟฟ้ากระแสและวงจร',
  ...
  'parts':[('กฎของโอห์มและความต้านทาน','Ohm\'s law & resistance','กราฟ V–I ของตัวต้านทานและตัวนำที่ไม่เป็นไปตามกฎของโอห์ม · การต่ออนุกรมและขนาน · สภาพต้านทานของลวด',['108','109','110','111']),
